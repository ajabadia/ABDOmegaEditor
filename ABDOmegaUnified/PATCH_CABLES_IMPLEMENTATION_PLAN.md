...
### 8.2. Tooltip de Información del Cable

Idea futura: al mantener pulsada la tecla `Alt` y pasar sobre un cable, mostrar un tooltip con la información de la ruta (source → target, tipo de señal, multiplicador).

### 8.3. Indicador de Flujo de Señal (Opcional)
...
- **Cable color picker**: Permitir al usuario personalizar el color de un cable.
...
### Ideas Propias
- **Agrupación de cables**: Si varios cables conectan el mismo par de módulos, agruparlos visualmente en un "mazo".
